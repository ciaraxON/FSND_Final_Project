export AUTH0_DOMAIN = 'dev-rq6zfmt3phu52com.us.auth0.com'
...
# database url
export SQLALCHEMY_DATABASE_URI = 'postgresql://postgres:Delphie06!@localhost:5432/Capstone'
...
export DATABASE_URL="postgresql://postgres:Delphie06!@localhost:5432/Capstone"
export EXCITED="true"
